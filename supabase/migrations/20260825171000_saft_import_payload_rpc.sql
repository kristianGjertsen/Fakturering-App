-- SAF-T XML payload import.
--
-- The browser parses XML into a normalized JSON payload. This RPC persists the
-- payload into the existing profile, master data and journal tables.

alter table public.saft_import_files
