...
export function createInvoicePreview({
  ...
  return {
    ...
    schedule_id: null,
    scheduled_for: null,
    invoice_number: isScheduled ? "Tildeles ved utsendelse" : "Tildeles ved utsendelse",
    title: invoiceTitle.trim() || (isScheduled ? "Tildeles ved utsendelse" : "Utkast"),
